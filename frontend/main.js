...
document.querySelector(".onPause").addEventListener("input", function () {
  document.querySelector(".onPauseText").innerHTML = `${
    this.value / 1000
  } seconds`;
});
...
document.querySelector(".offPause").addEventListener("input", function () {
  document.querySelector(".offPauseText").innerHTML = `${
    this.value / 1000
  } seconds`;
});
...
document.querySelector(".tree-form").addEventListener(
  "submit",
